                  ...
                  <CardContent className={classes.content}>
                      ...
                      >
                        <div className={classes.title}>
                          <Typography variant='caption' style={{backgroundColor:"tomato",padding:'3px'}}>camping</Typography>
                          <Typography variant='h5'>Lorem Ipsum</Typography>
                        </div>
                        <div className={classes.author}>
                          <Typography variant='caption'>By Beerdosan</Typography>
                          <Typography variant='caption' style={{marginLeft:'10px'}}>11 Nov 2021</Typography>
                        </div>
