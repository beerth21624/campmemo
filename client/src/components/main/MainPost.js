                ...
                <Card className={classes.root} square>
                    <CardActionArea>
                        ...
                        <CardMedia
                            ...
                            title="camp"
                        />
                        <Typography variant='caption' className={classes.carditem}>camping</Typography>
                        </div>
                        <CardContent>
                    ...
                    >
                    <Avatar alt="Remy Sharp" src="https://pbs.twimg.com/profile_images/1320044036179197952/hHmbojkt_400x400.jpg" className={classes.boxitem}/>
                    <Typography variant='subtitle1' color="textSecondary" className={classes.boxitem}>By beerdosan</Typography>
